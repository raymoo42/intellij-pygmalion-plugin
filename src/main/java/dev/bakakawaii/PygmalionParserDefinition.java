...
import dev.bakakawaii.parser.PygmalionParser;
import dev.bakakawaii.psi.PygmalionFile;
...
public class PygmalionParserDefinition implements ParserDefinition {
    ...
    public PsiFile createFile(FileViewProvider viewProvider) {
        return new PygmalionFile(viewProvider);
    }
    ...
    public PsiElement createElement(ASTNode node) {
        return PygmalionTypes.Factory.createElement(node);
    }
}
